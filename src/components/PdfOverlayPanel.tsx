                    ...
                    <div key={overlay.id} className="bg-[#212327] border border-white/5 rounded-xl p-3 space-y-3 group">
                        <div className="flex items-center justify-between gap-2">
                           ...
                           <div className="flex items-center gap-0.5 shrink-0">
                             ...
                             <button onClick={() => toggleVisibility(overlay.id)} className="p-1.5 hover:bg-white/5 rounded-lg text-gray-500 hover:text-white transition-all" title="Sembunyikan">
                                {overlay.visible ? <Eye className="w-3.5 h-3.5" /> : <EyeOff className="w-3.5 h-3.5" />}
                             </button>
                             <button onClick={() => removeOverlay(overlay.id)} className="p-1.5 hover:bg-red-500/10 rounded-lg text-gray-500 hover:text-red-400 transition-all" title="Hapus">
