...
export function UserProfileWidget() {
  ...
  return (
    <div className="absolute top-4 right-4 z-[9000] flex items-center gap-3 bg-card/85 backdrop-blur-xl border border-border/50 rounded-2xl p-1.5 shadow-xl transition-all hover:bg-card/95">
