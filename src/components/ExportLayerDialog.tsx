...
export const PROJECTIONS = [
  ...
  },
  {
    group: "📍 UTM Indonesia",
    items: [
      { value: "32746", label: "UTM Zone 46S (EPSG:32746)" },
      { value: "32747", label: "UTM Zone 47S (EPSG:32747)" },
      { value: "32748", label: "UTM Zone 48S (EPSG:32748)" },
      { value: "32749", label: "UTM Zone 49S (EPSG:32749)" },
      { value: "32750", label: "UTM Zone 50S (EPSG:32750)" },
      { value: "32751", label: "UTM Zone 51S (EPSG:32751)" },
      { value: "32752", label: "UTM Zone 52S (EPSG:32752)" },
      { value: "32753", label: "UTM Zone 53S (EPSG:32753)" },
      { value: "32754", label: "UTM Zone 54S (EPSG:32754)" },
    ]
  },
  {
    group: "🗺️ TM-3 Nasional (ATR/BPN)",
    items: [
       { value: "23826", label: "TM-3 Zona 46.1 (EPSG:23826)" },
       { value: "23827", label: "TM-3 Zona 46.2 (EPSG:23827)" },
       { value: "23828", label: "TM-3 Zona 47.1 (EPSG:23828)" },
       { value: "23829", label: "TM-3 Zona 47.2 (EPSG:23829)" },
       { value: "23830", label: "TM-3 Zona 48.1 (EPSG:23830)" },
       { value: "23831", label: "TM-3 Zona 48.2 (EPSG:23831)" },
       { value: "23832", label: "TM-3 Zona 49.1 (EPSG:23832)" },
       { value: "23833", label: "TM-3 Zona 49.2 (EPSG:23833)" },
       { value: "23834", label: "TM-3 Zona 50.1 (EPSG:23834)" },
       { value: "23835", label: "TM-3 Zona 50.2 (EPSG:23835)" },
       { value: "23836", label: "TM-3 Zona 51.1 (EPSG:23836)" },
       { value: "23837", label: "TM-3 Zona 51.2 (EPSG:23837)" },
       { value: "23838", label: "TM-3 Zona 52.1 (EPSG:23838)" },
       { value: "23839", label: "TM-3 Zona 52.2 (EPSG:23839)" },
       { value: "23840", label: "TM-3 Zona 53.1 (EPSG:23840)" },
       { value: "23841", label: "TM-3 Zona 53.2 (EPSG:23841)" },
       { value: "23842", label: "TM-3 Zona 54.1 (EPSG:23842)" },
    ]
  },
  {
    group: "⚙️ Lanjutan",
