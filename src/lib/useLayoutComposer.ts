...
function createDefaultElements(): LayoutElement[] {
  return [
    ...
    },
    {
      id: generateId(),
      type: "title",
      x: 5, y: 4, width: 90, height: 6,
      zIndex: 10,
      locked: false,
      config: { text: "PETA LOKASI", fontSize: 24, fontWeight: "bold", textAlign: "center", color: "#1a1a2e" },
    },
    {
      id: generateId(),
      type: "mapFace",
      x: 5, y: 12, width: 90, height: 58,
      zIndex: 1,
      locked: false,
    ...
    },
    {
      ...
      config: {
        ...
        instansi: "SAKAGIS Geospatial",
        keterangan: "Sumber data: SAKAGIS System",
